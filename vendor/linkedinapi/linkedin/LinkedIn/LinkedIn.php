...
class LinkedIn
{
    ...
    const SCOPE_BASIC_PROFILE = 'r_basicprofile'; // Nombre, foto, titular y posiciones actuales
    const SCOPE_FULL_PROFILE = 'r_fullprofile'; //Perfil completo incluyendo experiencia, educación, habilidades y recomendaciones
    const SCOPE_EMAIL_ADDRESS = 'r_emailaddress'; // La dirección de correo electrónico principal que utilizas para tu cuenta de LinkedIn
    const SCOPE_NETWORK = 'r_network'; // Sus conexiones de primer y segundo grado
    const SCOPE_CONTACT_INFO = 'r_contactinfo'; // Dirección, número de teléfono y cuentas vinculadas
    const SCOPE_READ_WRTIE_UPDATES = 'rw_nus'; // Recuperar y publicar actualizaciones a LinkedIn a medida que
    const SCOPE_READ_WRITE_GROUPS = 'rw_groups'; //Recupere y publique las discusiones de grupo
    const SCOPE_WRITE_MESSAGES = 'w_messages'; // Envía mensajes e invitaciones para que te conectes
